        ...
        {tabs.map((tab, i) => {
          ...
          return (
            <Link
              key={tab.href}
              href={tab.href}
              className={`relative flex-1 flex flex-col items-center gap-0.5 py-2 text-xs font-medium transition-colors ${
                active ? "text-[#3B7FF5] bg-[#3B7FF5]/10" : "text-white/90 hover:text-white hover:bg-white/5"
              } ${i > 0 ? "border-r" : ""}`}
